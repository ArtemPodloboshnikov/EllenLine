...
const ChangeItemFromDB = (props) => {
    ...
    return (
        <div className={classes.wrap} style={style}>
            ...
            <SelectEntered value={props.value} options={props.options} className={classes.select}
            arrowSize={arrowSize} onChangeFunction={props.onChangeFunction} name='ChooseItem'/>
        </div>
    )
}
